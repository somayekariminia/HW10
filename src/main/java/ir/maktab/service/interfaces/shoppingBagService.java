...
public interface shoppingBagService {
    void addProductToShoppingBag(Item item, User user) throws NotFoundException, SQLException;

    void deleteProductOfShoppingBag(Item item, User user) throws SQLException, NotFoundException;

    ArrayList<? extends Item> printAllProductsShoppingBag(User user) throws SQLException, NotFoundException;
